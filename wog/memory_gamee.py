...
def generate_sequence(diff):
    ...
    time.sleep(5)
    for x in range(100): # had to print, clear console using the os did not work properly (needed to emulate terminal, which makes the console look weird
        print()
    return num_array
...
def play(diff):
    ...
    is_list_equal(gen_arr,user_arr)
